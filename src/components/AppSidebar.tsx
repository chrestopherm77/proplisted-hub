...
export function AppSidebar() {
  ...
  const navItems = [
    ...
    { title: 'Alugue em Parceria', url: '/alugue-em-parceria', icon: Handshake, show: !isPartnerSite && !!isAdmin },
    ...
    { title: 'Benefícios', url: '/beneficios', icon: Gift, show: !isPartnerSite && !!isAdmin },
