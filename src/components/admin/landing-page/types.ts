...
export const DEFAULT_CONTENT: LPContent = {
  ...
  plans_section: {
    ...
    plans: [
      ...
      {
        name: 'Elite', price: 'R$ 79,90', priceSuffix: '/mês',
        credits: '150 créditos/mês', cta_label: 'Assinar Elite',
        cta_mode: 'link', cta_url: '',
        highlight: 'popular',
        features: [
          'Solicitações de parceria ilimitadas', 'Ofertas de parceria ilimitadas',
      ...
      {
        name: 'Quero ser parceiro', price: '', priceSuffix: '',
        credits: '', cta_label: 'Falar no WhatsApp',
        cta_mode: 'link', cta_url: 'https://wa.me/5516992456258',
        features: [
