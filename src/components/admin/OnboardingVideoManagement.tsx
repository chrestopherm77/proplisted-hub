...
import { OnboardingPlaylistManager } from './OnboardingPlaylistManager';
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Configure o vídeo principal e a playlist exibida na página de boas-vindas.
        </p>
      </div>

      <Tabs defaultValue="main" className="w-full">
        <TabsList>
          <TabsTrigger value="main">Vídeo principal</TabsTrigger>
