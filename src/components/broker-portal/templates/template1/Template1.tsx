      ...
      {openProperty ? (
        ...
        <>
          ...
          {(b.about_text || b.about_image_url) && (
            <section id="bp-sobre" className="py-12 container mx-auto px-4">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                {b.about_image_url && <img src={b.about_image_url} alt="sobre" className="rounded shadow w-full h-72 object-cover" />}
                <div>
                  <h2 className="text-3xl font-light mb-3">Sobre nós</h2>
                  <p className="text-neutral-700 whitespace-pre-line">{b.about_text || b.about}</p>
                </div>
              </div>
            </section>
          )}
