...
export default function Indicar() {
  ...
  const message = `Conheça o Conectae Imob: hub completo para o corretor de imóveis. De leads qualificados ao suporte administrativo, tudo o que você precisa para operar com autonomia.\n\nCadastre-se pelo meu link e comece agora:\n${link}`;
