-- Add address location fields to profiles table for city-based matching
ALTER TABLE public.profiles 
ADD COLUMN IF NOT EXISTS address_uf TEXT,
ADD COLUMN IF NOT EXISTS address_city TEXT,
ADD COLUMN IF NOT EXISTS address_neighborhood TEXT;

-- Create index for city-based lookups (for notification matching)
CREATE INDEX IF NOT EXISTS idx_profiles_address_city ON public.profiles(address_city);

-- Update handle_new_user function to include the new address fields
